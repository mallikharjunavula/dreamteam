                               ...
                               console.log(return_data);
								...
								div.setAttribute("id",id);
								 ...
								 if(nuller==null)
								 {
								   ...
								   newele.setAttribute("id","newplay");
								   document.getElementById("allplay").appendChild(newele);
                                ...
                                document.getElementById("points"+idgenerator).setAttribute("value",return_data[1]);
                                 ...
                                 console.log(document.getElementById("type"+idgenerator).getAttribute("value"));
